...
$projet = $projetBDD->un_projetx($projetID);
    ...
    //$email = mysqli_fetch_array($result)
        ...
        </span><p style="padding: 0; margin: 0;">Demande de désinscription de «' . $user->getNomU() . ' ' . $user->getPrenomU() . ',  ' . $user->getEmail() . '».<br> Dans l\'atelier  «' . $projet[0]['projet']->getTitreP() . '»  </p><span class="mso-font-fix-tahoma">
