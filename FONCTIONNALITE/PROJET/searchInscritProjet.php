...
if (isset($_POST['search'])) {
    ...
    $userMailEnd = $utilisateurs->projetSearchAutoCompete($userMail, $_POST['t'] );
    ...
    if (!empty($userMailEnd)) {
       echo( '<table class="table table-bordered">
        ...
        foreach ($userMailEnd as $value) {
             echo(  '<tr><td class="searchValue"><a href="../PROJET/inscriptionProjet.php?t=' .$_POST['t'].'&userId='. $value['Id'] . '&c=yes">' . $value['Email'] .'</a></td></tr>');
