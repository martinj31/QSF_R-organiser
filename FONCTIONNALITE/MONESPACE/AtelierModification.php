                ...
                <form action="../ATELIER/Modifier1Atelier.php" method="POST">
                    ...
                    foreach ($atelierTab as $value) { /* Afficher le détail de chaque besoin */
                        ...
                        if ($value['atelier']->getVisibiliteA() == 1) {
                            ...
                            echo('<input type="text" name="date" value="' . $value['atelier']->getDateA() . '" class="form-control col-md-4" id="inputEmail4" maxlength="100" required>');
                            echo('</div>');
                            ...
                            echo ('<input type="text" name="url" class="form-control col-md-4" id="inputEmail4" maxlength="100" value="' . $value['atelier']->getURL() . '" required>');
                            echo ('</div>');
